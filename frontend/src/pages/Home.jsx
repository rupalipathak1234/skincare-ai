const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <button className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-full text-lg shadow-lg transition duration-300 transform hover:-translate-y-1">
        Start Assessment
      </button>
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl text-left">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <p className="text-gray-500 text-sm">Upload a photo for a completely private, AI-assisted visual check (Coming Soon).</p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
